<template>
  <div class="pop-window">
    <div class="window-header">자동단어분할</div>
          ...
          <div class="grid-wrap">
            <div class="grid-top">
              <div class="top-row">
                <div class="title-s">
                  용어영문약어명 조합
                  <AppTooltip :htmlContent="getTooltipById('termComposition')">
                  </AppTooltip>
                </div>
              </div>
            </div>
...
<script>
  ...
  import { getTermDivideV2 } from '@/utils/mflexApi/dictionaryMng/dictionaryV2Api.js';
  ...
  export default {
    ...
    setup(props, { emit }) {
      ...
      // rowClassRules 추가 - 에러가 있는 행을 붉은색으로 표시
      ...
      const fetchData = async () => {
        ...
        try {
          const response = await getTermDivideV2(termDivideQuery);
