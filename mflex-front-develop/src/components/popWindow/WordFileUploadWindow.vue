<template>
  <div class="pop-window">
    <div class="window-header">단어 일괄등록</div>
                    ...
                    <div class="upload-area">
                      ...
                      <div class="file-area">
                        ...
                        <div class="btn-area">
                          ...
                          />
                          <a
                            :href="`${apiUrl}/api/v1/download/word-template`"
                            class="btn-s"
                            >양식내려받기</a
                          >
                          <button
...
<script>
  ...
  import { uploadWordFileV2 } from '@/utils/mflexApi/dictionaryMng/dictionaryV2Api.js';
  ...
  export default {
    ...
    setup(props, { emit }) {
      ...
      const onConfirm = async () => {
        ...
        const response = await uploadWordFileV2(wordFormData.value);
      ...
      const downloadErrorFile = () => {
        ...
        link.download = `단어등록_오류내역_(${sysdate}).xlsx`; // 다운로드할 파일명 설정
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);
      ...
      onMounted(() => {
        ...
        console.log('onMounted wordFileInput : ', wordFileInput);
