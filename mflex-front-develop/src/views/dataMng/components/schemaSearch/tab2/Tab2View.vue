...
<script setup>
  ...
  import TopComp from '@/views/dataMng/components/schemaSearch/tab2/top/TopComp.vue';
  import BottomComp from '@/views/dataMng/components/schemaSearch/tab2/bottom/BottomComp.vue';
