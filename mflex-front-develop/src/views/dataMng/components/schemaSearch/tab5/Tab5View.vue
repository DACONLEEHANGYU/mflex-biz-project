...
<script setup>
  ...
  import TopComp from '@/views/dataMng/components/schemaSearch/tab5/top/TopComp.vue';
  import BottomComp from '@/views/dataMng/components/schemaSearch/tab5/bottom/BottomComp.vue';
