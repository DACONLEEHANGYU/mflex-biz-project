...
<script setup>
  ...
  import TopComp from '@/views/dataMng/components/schemaSearch/tab4/top/TopComp.vue';
  import BottomComp from '@/views/dataMng/components/schemaSearch/tab4/bottom/BottomComp.vue';
