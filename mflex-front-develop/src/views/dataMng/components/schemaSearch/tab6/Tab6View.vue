...
<script setup>
  ...
  import TopComp from '@/views/dataMng/components/schemaSearch/tab6/top/TopComp.vue';
  import BottomComp from '@/views/dataMng/components/schemaSearch/tab6/bottom/BottomComp.vue';
