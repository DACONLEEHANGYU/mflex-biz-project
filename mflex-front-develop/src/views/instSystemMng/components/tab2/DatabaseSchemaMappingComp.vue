<template>
  ...
  <AppWindow :view="editDatabaseSchemaWindowState" width="1200px" height="auto">
    <InstAdminEditDatabaseSchemaWindow
...
<script setup>
  ...
  import InstAdminEditDatabaseSchemaWindow from '@/components/popWindow/InstAdminEditDatabaseSchemaWindow.vue';
