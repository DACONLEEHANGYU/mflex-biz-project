<template>
  <section
    :class="{
      'contents-wrap': swipper,
      'contents-wrap-none-history': !swipper,
    }"
  >
...
<script setup>
  ...
  const Tab1View = defineAsyncComponent(() =>
    import('@/views/dictionarySearch/components/tab1/Tab1View.vue')
  );
  const Tab2View = defineAsyncComponent(() =>
    import('@/views/dictionarySearch/components/tab2/Tab2View.vue')
  );
  const Tab3View = defineAsyncComponent(() =>
    import('@/views/dictionarySearch/components/tab3/Tab3View.vue')
  );
  ...
  onDeactivated(() => {
    console.log('dictionary Search === onDeactivated');
  });
</script>
