...
const BottomTab1 = defineAsyncComponent(() =>
  import('@/views/dictionarySearch/components/tab3/bottom/BottomTab1.vue'),
);
const BottomTab2 = defineAsyncComponent(() =>
  import('@/views/dictionarySearch/components/tab3/bottom/BottomTab2.vue'),
);
const BottomTab3 = defineAsyncComponent(() =>
  import('@/views/dictionarySearch/components/tab3/bottom/BottomTab3.vue'),
);

const tabList = reactive(['기본정보', '연관용어', '변경이력']);
