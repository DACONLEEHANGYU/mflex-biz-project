...
<script setup>
  ...
  const BottomTab1 = defineAsyncComponent(() =>
    import('@/views/dictionarySearch/components/tab1/bottom/BottomTab1.vue')
  );
  const BottomTab2 = defineAsyncComponent(() =>
    import('@/views/dictionarySearch/components/tab1/bottom/BottomTab2.vue')
  );
  const BottomTab3 = defineAsyncComponent(() =>
    import('@/views/dictionarySearch/components/tab1/bottom/BottomTab3.vue')
  );
  const BottomTab4 = defineAsyncComponent(() =>
    import('@/views/dictionarySearch/components/tab1/bottom/BottomTab4.vue')
  );
  const BottomTab5 = defineAsyncComponent(() =>
    import('@/views/dictionarySearch/components/tab1/bottom/BottomTab5.vue')
  );
  const BottomTab6 = defineAsyncComponent(() =>
    import('@/views/dictionarySearch/components/tab1/bottom/BottomTab6.vue')
  );
  const BottomTab7 = defineAsyncComponent(() =>
    import('@/views/dictionarySearch/components/tab1/bottom/BottomTab7.vue')
  );
