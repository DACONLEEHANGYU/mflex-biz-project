...
<script setup>
  ...
  import TopComp from '@/views/actualizing/components/termActualizing/top/TopComp.vue';
  import BottomComp from '@/views/actualizing/components/termActualizing/bottom/BottomComp.vue';
  ...
  defineOptions({ name: 'ActualizingTerm' });
