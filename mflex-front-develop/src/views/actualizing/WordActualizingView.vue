...
<script setup>
  ...
  import TopComp from '@/views/actualizing/components/wordActualizing/top/TopComp.vue';
  import BottomComp from '@/views/actualizing/components/wordActualizing/bottom/BottomComp.vue';
  ...
  defineOptions({ name: 'ActualizingWord' });
