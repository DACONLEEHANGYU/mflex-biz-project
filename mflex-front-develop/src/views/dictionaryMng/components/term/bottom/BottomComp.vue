...
<script>
  ...
  import RigthComp from '@/views/dictionaryMng/components/term/bottom/manage/RigthComp.vue';
  import LeftComp from '@/views/dictionaryMng/components/term/bottom/jobBox/LeftComp.vue';
  export default {
    components: {
      RigthComp,
      LeftComp,
