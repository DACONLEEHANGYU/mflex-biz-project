...
<script setup>
  ...
  import TopComp from '@/views/dictionaryMng/components/domain/top/TopComp.vue';
  import BottomComp from '@/views/dictionaryMng/components/domain/bottom/BottomComp.vue';
  ...
  defineOptions({ name: 'DomainMngView' });
