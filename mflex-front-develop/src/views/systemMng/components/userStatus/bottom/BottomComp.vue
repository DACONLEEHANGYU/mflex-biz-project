...
const BottomTab1 = defineAsyncComponent(() =>
  import('@/views/systemMng/components/userStatus/bottom/BottomTab1.vue'),
);
const BottomTab2 = defineAsyncComponent(() =>
  import('@/views/systemMng/components/userStatus/bottom/BottomTab2.vue'),
);
const BottomTab3 = defineAsyncComponent(() =>
  import('@/views/systemMng/components/userStatus/bottom/BottomTab3.vue'),
);
const BottomTab4 = defineAsyncComponent(() =>
  import('@/views/systemMng/components/userStatus/bottom/BottomTab4.vue'),
);
const BottomTab5 = defineAsyncComponent(() =>
  import('@/views/systemMng/components/userStatus/bottom/BottomTab5.vue'),
);
const BottomTab6 = defineAsyncComponent(() =>
  import('@/views/systemMng/components/userStatus/bottom/BottomTab6.vue'),
);
const BottomTab7 = defineAsyncComponent(() =>
  import('@/views/systemMng/components/userStatus/bottom/BottomTab7.vue'),
);
