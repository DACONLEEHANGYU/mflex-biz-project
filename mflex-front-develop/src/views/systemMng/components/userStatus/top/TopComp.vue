<template>
    ...
    <div class="grid-wrap">
      <div class="grid-top">
        ...
        <div class="title-btns__row_btween">
          ...
          <div class="btns">
            <!-- <button class="btn-s green">활성/정지</button>
            <button class="btn-s blue">잠김해제</button> -->
            <!-- <button class="btn-s dark-blue">사용자 일괄등록</button> -->
          </div>
        </div>
  ...
  <AppWindow width="600px" :view="createUserView" @close="onClosedCreateUser">
    <CreateUserByAdminWindow @close="onClosedCreateUser" @confirm="fetchData" />
  </AppWindow>
  ...
  export default {
    ...
    setup(props) {
      ...
      const columnDefs = reactive([
        ...
        //   field: 'loginStatus',
        //   cellClass: 'grid-cell-centered',
        //   cellRenderer: 'LoginStateCellrenderer',
        //   valueFormatter: (params) => params.value,
        //   width: 120,
        // },
        // {
      ...
      const fetchData = async () => {
        ...
        // for (let i = 0; i < 10; i++) {
        //   // const approvalStatus = Math.random() < 0.5 ? '미승인' : '승인';
        //   // const isPasswordReset = Math.random() < 0.7; // 70% 확률로 비밀번호 초기화 완료
        //   // const isActive = Math.random() < 0.8; // 80% 확률로 활성화 상태
        ...
        //     id: i,
        //     no: i + 1,
        //     lock: Math.floor(Math.random() * 2) === 0 ? '잠김' : '',
        //     stop: Math.floor(Math.random() * 2) === 0 ? '정지' : '',
        //     userId: 'tester' + i,
        //     userName: '테스터',
        //     userType: '일반사용자',
        //     approvalStatus: approvalStatus,
        //     userStatus: setUserStatus(approvalStatus),
